...
public class OrderLinkedList<T extends Comparable<T>> {
	...
	public void insert(T data) {// 插入 到 链头，并排序
		...
		if (previous == null) {//表示是第1个就为空
			first = newLink;
		} else {
			previous.next = newLink; //上一结点的next指向新节点
		}
	...
	public static void main(String[] args) {
		OrderLinkedList<Integer> list = new OrderLinkedList<Integer>();
		list.insert(1);
		list.insert(3);
		list.insert(2);
		list.insert(8);
		...
		System.out.println("delete find:" + list.delete(3));
		list.displayList();
